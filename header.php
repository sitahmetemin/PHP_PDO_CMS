...
include 'nedmin/veriTabani/baglan.php';
include 'nedmin/veriTabani/fonk.php';
                ...
                <div class="header-row">
                    <div class="header-column">
                        <div class="header-logo">
                            <a href="index.php">
                                <img alt="Porto" width="164" height="54" data-sticky-width="82" data-sticky-height="40"
                                     data-sticky-top="33" src="<?php echo $ayarcek['ayar_logo'];?>">
                            </a>
                        </div>
                    </div>
                    <div class="header-column">
                    ...
                    <div class="header-search visible-lg">
                        <form id="searchForm" action="page-search-results.html" method="get">
                            <div class="input-group">
                                <input type="text" class="form-control" name="q" id="q" placeholder="Ara..." required>
                        ...
                        <nav>
                            <ul class="nav nav-pills" id="mainNav">
                                ...
                                <li <?php if ($say>0) echo "class='dropdown'"; ?> >
                                    ...
                                    <?php } ?>"><i class="<?php echo $menucek['menu_icon']; ?>"></i>&nbsp;<?php echo $menucek['menu_ad'];?></a>
                                    <ul class="dropdown" >
                                        <?php
                                    ...
                                    <?php } ?>"><?php echo $altMenucek['menu_ad'];?></a>
                                        </li>
                                        <?php } ?>
                                    </ul>
                                </li>
